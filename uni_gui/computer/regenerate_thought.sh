#!/usr/bin/env bash
# Condense verbose model reasoning into concise qwen3-vl-style thoughts.
#
# This wraps regenerate_thought.py. It rewrites the `thought` field of every
# step in each task.json (moving the original into `raw_thought`).
#
