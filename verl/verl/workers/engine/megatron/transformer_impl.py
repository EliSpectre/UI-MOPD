...
class MegatronEngine(BaseEngine):
        ...
        if self.bridge is not None:
            for m in module:
                ...
                if hasattr(m, "decoder"):
                    m.freeze(
                        freeze_language_model=self.model_config.freeze_language_model,
                        freeze_vision_model=self.model_config.freeze_vision_tower,
                        freeze_vision_projection=self.model_config.freeze_vision_projection,
                    )
    ...
    def _build_lr_scheduler(self):
        ...
        register_megatron_training_hooks(self.module, self.optimizer)
    ...
    def optimizer_step(self):
        ...
        return grad_norm, num_zeros_in_grad
    ...
    def forward_backward_batch(self, data: TensorDict, loss_function: Callable, forward_only=False) -> Any:
        ...
        for micro_batch in micro_batches:
            ...
            loss_mask = micro_batch["loss_mask"].to(bool)
            position_ids = micro_batch["position_ids"]
            multi_modal_inputs = micro_batch.get("multi_modal_inputs", None)
        
            data_list = multi_modal_inputs.data
