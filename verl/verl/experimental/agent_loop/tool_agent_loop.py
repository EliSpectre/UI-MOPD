...
class AgentData:
    ...
    def __init__(
        ...
        self.routed_experts_cache_id: Optional[str] = None
        self.routed_experts_cache_source: Optional[str] = None
        self.user_turns = 0
...
class ToolAgentLoop(AgentLoopBase):
    ...
    async def run(self, sampling_params: dict[str, Any], **kwargs) -> AgentLoopOutput:
        ...
        output = AgentLoopOutput(
            ...
            routed_experts_cache_id=agent_data.routed_experts_cache_id,
            routed_experts_cache_source=agent_data.routed_experts_cache_source,
    ...
    async def _handle_generating_state(
        ...
        if output.routed_experts_cache_id is not None:
            agent_data.routed_experts_cache_id = output.routed_experts_cache_id
            agent_data.routed_experts_cache_source = output.routed_experts_cache_source
