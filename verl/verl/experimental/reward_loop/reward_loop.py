...
class RewardLoopWorker:
    def __init__(self, config: DictConfig, reward_router_address: str = None, mode: str = None):
        """
        ...
        Args:
            ...
            mode: str, the mode of the reward loop worker (e.g. "train" or "eval").
        """
        self.config = config
...
class RewardLoopManager:
    ...
    def __init__(self, config: DictConfig, rm_resource_pool: RayResourcePool = None, mode: str = None):
        self.config = config
        self.mode = mode
        if self.config.reward_model.enable:
    ...
    def _init_reward_loop_workers(self):
        ...
        for i in range(num_workers):
            ...
            self.reward_loop_workers.append(
                ...
                ).remote(self.config, self.reward_router_address, mode=self.mode)
            )
