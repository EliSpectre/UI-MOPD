...
class AlgoConfig(BaseConfig):
    ...
    Args:
        ...
        use_kl_in_advantage (bool): Whether to enable in-advantage KL penalty.
    ...
    use_kl_in_advantage: bool = False
    use_topk_distillation: bool = False
    topk_size: int = 200
    alpha: float = 0.0
    topk_kl_loss_weight: float = 1.0
    kl_penalty: str = "kl"
